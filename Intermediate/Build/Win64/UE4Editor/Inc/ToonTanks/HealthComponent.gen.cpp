...
// End Cross Module References
	...
	{
		P_GET_OBJECT(AActor,Z_Param_DamagedComp);
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->DamageTaken(Z_Param_DamagedComp,Z_Param_Damage,Z_Param_DamageType,Z_Param_Instigator,Z_Param_DamageCauser);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_DamagedComp;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::NewProp_DamagedComp = { "DamagedComp", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HealthComponent_eventDamageTaken_Parms, DamagedComp), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::NewProp_DamagedComp,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_DamageTaken, "DamageTaken" }, // 2639446424
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHealthComponent, 1649821604);
