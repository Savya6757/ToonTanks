...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATower_Statics::NewProp_ShootingRange_MetaData[] = {
		{ "Category", "Tower" },
		{ "ModuleRelativePath", "Tower.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATower_Statics::NewProp_ShootingRange = { "ShootingRange", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATower, ShootingRange), METADATA_PARAMS(Z_Construct_UClass_ATower_Statics::NewProp_ShootingRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATower_Statics::NewProp_ShootingRange_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATower_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATower_Statics::NewProp_ShootingRange,
	};
	...
	IMPLEMENT_CLASS(ATower, 3530650697);
